...
@Component({
  ...
  templateUrl: './memento-pattern.component.html',
  styleUrls: ['./memento-pattern.component.scss']
})
export class MementoPatternComponent extends PatternBase implements OnInit {
  pattern: string;
