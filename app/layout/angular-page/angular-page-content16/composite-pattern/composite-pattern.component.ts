...
@Component({
  ...
  templateUrl: './composite-pattern.component.html',
  styleUrls: ['./composite-pattern.component.scss']
})
export class CompositePatternComponent extends PatternBase implements OnInit {
  pattern: string;
