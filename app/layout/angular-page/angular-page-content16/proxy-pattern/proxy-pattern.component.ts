...
@Component({
  ...
  templateUrl: './proxy-pattern.component.html',
  styleUrls: ['./proxy-pattern.component.scss']
})
export class ProxyPatternComponent extends PatternBase implements OnInit {
  pattern: string;
