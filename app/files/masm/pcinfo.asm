...
COMMENT *
	 Written by László Kővári  1987.07.07.
		      	  Last update  1988.01....
...
DATA	SEGMENT PARA	PUBLIC	'DATA'
	...
	M	db	'László Kővári `87 Hungary 3980 Satoraljaujhely Kazinczy 22.'
	T0	db	'IIIII    BBBBBBBBB     MMMMMM       MMMMMM','$'
	T1	db	'IIIII    BBB    BBB    MMMMMMM     MMMMMMM','$'
	T2	db	' III     BBB    BBB    MMMMMMM     MMMMMMM ','$'
	T3	db	' III     BBBBBBBB      MMM  MMMM MMMM  MMM ','$'
	T4	db	' III     BBBBBBBB      MMM   MMMMMMM   MMM ','$'
	T5	db	' III     BBB    BBB    MMM    MMMMM    MMM ','$'
	T6	db	'IIIII    BBB    BBB    MMMM    MMM    MMMM','$'
	T7	db	'IIIII    BBBBBBBBB     MMMM     M     MMMM','$'
	Text1	db	'Információk a számitógépről','$'
	Under	db	'===========================','$'
	Text2	db	'Játék port....................................:','$'
	...
	Text7	db	'RS232 kártyák száma...........................:   db.','$'
	Text8	db	'Szines grafikus kártya........................:','$'
	Text9	db	'R O M létrehozás ideje........................:','$'
	Text10	db	'RAM. a rendszer kártyán.......................:    K.byte.','$'
	Text11	db	'Valós idős óra a rendszerben..................:','$'
	Text12	db	'A számitógép ROM. beli azonosiitója............:','$'
	...
	Text17	db	'Fix lemez maximális kapacitása................:          byte.','$'
	Text18	db	'Cilinderek száma fix lemezen..................:     db.','$'
	Text19	db	'Fix lemez szabad kapacitása...................:          byte.','$'
	...
	Van	db	'van.','$'
	Nincs	db	'nincs.','$'
	Maker	db	'(C) László Kővári`87','$'
	xp	db	0
	yp	db	0
	One	db	'Ez a számitógép egy eredeti IBM PC.','$'
	Two	db	'Ez a számitógép egy IBM PC XT vagy egy hordozható PC.','$'
	Thre	db	'Ez a számitógép egy IBM PC junior.','$'
	Four	db	'Ez a számitógép egy IBM PC AT.','$'
	Five	db	'Ez a számitógép teljesen IBM PC kompatibilis.','$'
	Six	db	'Ez a számitógép teljesen IBM XT kompatibilis.','$'
	Error	db	'Ismeretlen gépazonositó byte. A gép nem eredeti.','$'
	a		dw	(0a90h)
	b		dw	(09f8h)
	h		dw	(0969h)
	c		dw	(08e2h)
