...
@Component({
  ...
  templateUrl: './command-pattern.component.html',
  styleUrls: ['./command-pattern.component.scss']
})
export class CommandPatternComponent extends PatternBase implements OnInit {
  pattern: string;
