...
@Component({
  ...
  templateUrl: './mediator-pattern.component.html',
  styleUrls: ['./mediator-pattern.component.scss']
})
export class MediatorPatternComponent extends PatternBase implements OnInit {
  pattern: string;
