...
@Component({
  ...
  templateUrl: './visitor-pattern.component.html',
  styleUrls: ['./visitor-pattern.component.scss']
})
export class VisitorPatternComponent extends PatternBase implements OnInit {
  pattern: string;
