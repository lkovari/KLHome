...
@Component({
  ...
  templateUrl: './flyweight-pattern.component.html',
  styleUrls: ['./flyweight-pattern.component.scss']
})
export class FlyweightPatternComponent extends PatternBase implements OnInit {
  pattern: string;
