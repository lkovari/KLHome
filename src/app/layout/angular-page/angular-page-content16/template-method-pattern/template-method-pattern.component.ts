...
@Component({
  ...
  templateUrl: './template-method-pattern.component.html',
  styleUrls: ['./template-method-pattern.component.scss']
})
export class TemplateMethodPatternComponent extends PatternBase implements OnInit {
  pattern: string;
