...
export class AngularPageContent11Component implements OnInit {
  ...
  checklistItems: ChecklistItem[] = [
    ...
    { id: 7, label: "Vanadis 10 This is a list item, where the label's text is longer than what used in the most common cases. This is the demonstration of how the test fit into two rows, and how aligned the icon.", selected: false, value: null },
