...
COMMENT *
	Written by László Kővári  1995.02.13.
...
;
;
	Copyr	db	'Copyright (C) 1995 by L�szl� K�v�ri #3647321033$'
	...
	Scr	db	'+------------------+ Horizontal Total R00..............:    +-----------------+',13,10
		...
		db	'| by László Kővári | Vertical Total R06................:    |      Value      |',13,10
