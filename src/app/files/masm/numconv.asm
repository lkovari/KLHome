...
COMMENT *
	 Written by László Kővári   1987.04.20.
...
;			  |  | | | | | |  |  | | |
	...
	TEXT0	DB	'László Kővári Software.','$'
	TEXT1	DB	'MCMLXXXVII.','$'
	TEXT2	DB	'INPUT : ','$'
	TEXT3	DB	'OUTPUT : ','$'
	TEXT4	DB	'Számrendszer :','$'
	TEXT5	DB	'Érték : ','$'
	TEXT6	DB	'EGÉSZ SZÁMOK KONVERTÁLÁSA.','$'
	TEXT7	DB	'Újra ?  I - N...','$'
	MESS0	DB	'A program segitségével 0 és 262143 közzé eső egész számok kon-','$'
	MESS1	DB	'vertálhatók át más számrendszerbe. A számrendszer 2 és 36 köz-','$'
	MESS2	DB	'zó eshet. Túl nagy szám esetén a program figyelmeztetést kúld !','$'
	ERMS0	DB	'Hibás számrendszer érték !','$'
	ERMS1	DB	'Túl nagy értek !','$'
	CLR	DB	'                                        ','$'
	CLSYS	DB	'                  ','$'
	CLVLU	DB	'                        ','$'
	CLEARSC DB	' ',10,13,'$'
