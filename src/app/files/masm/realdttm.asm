...
COMMENT *
	Written by László Kővári  1987.05.30.
...
DATA	SEGMENT PARA	PUBLIC	'DATA'
	...
	space		db	'00','$'
	text0		db	'VALÓS DÁTUM ÉS IDŐ',13,10,'$'
	text1		db	'Dátum    : ','$'
	text2		db	'Id?      : ','$'
	text3		db	'Uj dátum : ','$'
	text4		db	'Uj idő?   : ','$'
	text5		db	'Copyright (C) 1987 by László Kővári #3747321033$'
	errms		db	'Rossz !','$'
	clrscr		db	' ',13,10,'$'
	clrdt		db	'                 ','$'
	clrtm		db	'            ','$'
	sunday		db	'Vasárnap','$'          ;A het napjai
	monday		db	'Hétfő','$'
	tuesday 	db	'Kedd','$'
	wednesday	db	'Szerda','$'
	thursday	db	'Csűtörtök','$'
	friday		db	'Péntek','$'
	saturday	db	'Szombat','$'
	trn		dw	0		;Cimtarolo
